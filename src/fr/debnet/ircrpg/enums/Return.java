...
public enum Return {
    ...
    TYPE_ALREADY_EQUIPPED       (0x97, Strings.RETURN_TYPE_ALREADY_EQUIPPED),
    ITEM_SUCCESSFULLY_BOUGHT    (0x98, Strings.RETURN_ITEM_SUCCESSFULLY_BOUGHT),
    ITEM_SUCCESSFULLY_SOLD      (0x99, Strings.RETURN_ITEM_SUCCESSFULLY_SOLD),
    POTION_PRICE_TOO_HIGH       (0x9A, Strings.RETURN_POTION_PRICE_TOO_HIGH),
    POTION_SUCCESSFULLY_BOUGHT  (0x9B, Strings.RETURN_POTION_SUCCESSFULLY_BOUGHT),
    POTION_SUCCESSFULLY_SOLD    (0x9C, Strings.RETURN_POTION_SUCCESSFULLY_SOLD),
    // Learning returns
