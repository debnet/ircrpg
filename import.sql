...
(1, 'WORKING', 0.2, 'working 1', '<n>Le propriétaire de la ferme trouve que <purple><player.nickname><n> a bien travaillé et lui accorde une prime de <brown><playerGoldChanges;%=.1f><n> pièce(s) d''or.', 0, 50, 30, 0, 0, 10, 0, 0, 'NONE', b'1', b'0', 0.2, 0),
(2, 'RESTING', 0.2, 'resting 1', '<n>L''aubergiste a offert un bon repas chaud à <purple><player.nickname><n>, lui permettant de regagner instantanément <dgreen><playerHealthChanges;%=.1f><n> points de santé.', 0, 0, 0, 50, 30, 10, 0, 0, 'NONE', b'1', b'1', 0.2, 0),
(3, 'TRAINING', 0.2, 'training 1', '<n>Le maître d''armes a profité d''un moment avec <purple><player.nickname><n> pour lui apprendre quelques techniques, lui conférant ainsi <dgreen><playerExperienceChanges;%=.1f><n> points d''expérience.', 30, 0, 0, 0, 0, 10, 0, 0, 'NONE', b'1', b'0', 0.2, 0);
